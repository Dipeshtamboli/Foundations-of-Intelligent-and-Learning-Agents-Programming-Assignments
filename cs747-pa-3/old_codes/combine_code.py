...
class GridWorld(object):
	...
	def expected_sarsa_update(self,state,action,reward,next_s,next_action):
		next_greedy_a = np.argmax(self.Q_tab[next_s["r"],next_s["c"],:])
		Target = reward 
...
if __name__ == '__main__':
	...
	parser.add_argument('--num_actions', default=8, help='Number of available actions(up, down, east, west, etc.).')
	...
	parser.add_argument('--stochastic', default=False, help='q_learning,sarsa,exp_sarsa')
